...
```js
{
	...
	// Заводской Modbus ID устройства, в десятичной системе
	// Поле без функционала, парсится в строку и выводится в окне конфигурации
	"modbusID" : 30
...
### To-Do
- Добавить возможность записи в списке автоопрашиваемых записей.
	-- Выделить отображение значений в отдельный метод для упрощения 
